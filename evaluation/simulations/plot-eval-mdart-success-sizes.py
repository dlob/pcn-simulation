...
plotPath = os.path.abspath('eval-mdart-success-size.pdf')
...
for scenarioName in scenarios:
	...
	for stdoutFile in stdoutFiles:
		...
		xx[0] = 1
		axs[0, 0].plot(xx, spline(xx), lineTypes[algName], label=algNames[algName] + ' ' + templateSize(stdoutFile))
